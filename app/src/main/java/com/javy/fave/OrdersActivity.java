...
import com.javy.fave.adapters.AdapterListOrders;
...
public class OrdersActivity extends AppCompatActivity implements OnSuccessListener {
...
//        errorLoadingRelativeLayout = view.findViewById(R.id.errorLoading);
        ...
        NetworkUtils.
                fetchData("GET","orders",null
                        ,OrdersActivity.this,OrdersActivity.this);
...
//                obj.endlat = orders.getJSONObject(i).getString("end_lat");

//                if (orders.getJSONObject(i).has("end_lat") &&
//                        !orders.getJSONObject(i).isNull("end_lat")) {
//                    obj.endlat = orders.getJSONObject(i).getString("end_lat");
//                }

//
////                obj.endlong = orders.getJSONObject(i).getString("end_long");
                String customerName = "";
                if (orders.getJSONObject(i).has("customer") &&
                        !orders.getJSONObject(i).isNull("customer")) {
                    customerName = orders.getJSONObject(i).getJSONObject("customer").getString("name")+" - ";
                }
...
//                if (
//                orders.getJSONObject(i).has("lead") &&
//                        orders.getJSONObject(i).get("lead") instanceof JSONObject
//                ) {
//                    accountName = orders.getJSONObject(i).
//                            getJSONObject("lead").getString("name");
//                }else if(
//                        orders.getJSONObject(i).has("account") &&
//                                orders.getJSONObject(i).get("account") instanceof JSONObject
//                ){
...
//                obj.account_name = accountName;
            ...
            mAdapter = new AdapterListOrders(items);
...
//                        JSONArray accounts = jsonObject.getJSONArray("orders");
...
//            Toasts.toastIconError(getContext(),"Error Loading");
            Toast.makeText(OrdersActivity.this, "Error Loading",
