...
public class AdapterListPayments extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterListPayments(Context context, List<Payment> items) {
        this.items = items;
        ctx = context;
    }
    public AdapterListPayments(List<Payment> items) {
        this.items = items;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            view.startlocation.setText("#"+p.id);
            view.date.setText(p.date);
            view.endlocation.setText(p.status);
            view.amount.setText(p.total);
