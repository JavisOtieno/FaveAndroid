...
public class AdapterListOrders extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterListOrders(Context context, List<Order> items) {
        this.items = items;
        ctx = context;
    }
    public AdapterListOrders(List<Order> items) {
        this.items = items;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            view.startlocation.setText(p.customerName);
            view.date.setText(p.date);
            view.endlocation.setText(p.orderDetails);
